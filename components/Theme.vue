...
<script>
    ...
    export default {
        ...
        methods: {
            changeTheme(theme) {
                this.$store.commit('theme/change', theme);
            }
        }
    }
</script>
    ...
    #sidebar-theme
        ...
        aside
            ...
            ul
                ...
                height: 100%
                width: 100%
                box-shadow: 0px 3px 8px -1px #00000059
